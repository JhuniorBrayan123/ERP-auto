import {test} from '../../../src/fixtures/Logistica/movimientos-fixture';
import {
    ALMACENES,
    ITEMS_TEST,
    MOTIVOS_AJUSTE,
...
test.describe('Ajustes de Almacén @ajuste', {tag: ['@logistica', '@movimientos']}, () => {
//Esto es un nuevo test desde consola escribiendo con los ojos puestos en el teclado y en el cursor del desde el nuevo sitio de Junuior
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe registrar un ajuste tipo Agregar e incrementar stock', async ({
                                                                                 movimientosNav,
                                                                                 registroMovimiento,
                                                                                 resultadoMovimiento,
                                                                                 stockVerificacion,
        ...
        await test.step('And: verificar movimiento en kardex', async () => {
            ...
            await kardexVerificacion.abrirVerDetallePorAlmacen(ALMACENES.AUTO);
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe registrar un ajuste tipo Quitar y disminuir stock', async ({
                                                                              movimientosNav,
                                                                              registroMovimiento,
                                                                              resultadoMovimiento,
                                                                              stockVerificacion,
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe registrar un ajuste con insumo y verificar stock', async ({
                                                                             movimientosNav,
                                                                             registroMovimiento,
                                                                             resultadoMovimiento,
                                                                             stockVerificacion,
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe registrar un ajuste con ítem equivalente y verificar stock', async ({
                                                                                       movimientosNav,
                                                                                       registroMovimiento,
                                                                                       resultadoMovimiento,
                                                                                       stockVerificacion,
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe registrar ajuste con datos adicionales y campos personalizados', async ({
                                                                                           movimientosNav,
                                                                                           registroMovimiento,
                                                                                           datosOpcionales,
                                                                                           resultadoMovimiento,
        ...
        await test.step('And: verificar kardex y datos opcionales', async () => {
            ...
            await kardexVerificacion.abrirVerDetallePorAlmacen(ALMACENES.VENTAS);
            await kardexVerificacion.expectPatronCodigoMovimientoVisible(PATRON_CODIGO.AJUSTE);
