...
import {ITEMS_TEST, PATRON_CODIGO, PROVEEDOR_EXISTENTE,} from '../../../src/helpers/Logistica/movimiento-data.helper';

test.describe('Clonación de Movimientos @clonacion', {tag: ['@logistica', '@movimientos']}, () => {

    // ═══════════════════════════════════════════════════════════════
    // Scenario 28: Clonar movimiento correctamente
    // ═══════════════════════════════════════════════════════════════
    test('debe clonar un ingreso y verificar nuevo movimiento en kardex', async ({
                                                                                     movimientosNav,
                                                                                     registroMovimiento,
                                                                                     resultadoMovimiento,
                                                                                     listadoMovimientos,
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe clonar ingreso con equivalencia y respetar lógica de equivalencia', async ({
                                                                                              movimientosNav,
                                                                                              registroMovimiento,
                                                                                              resultadoMovimiento,
                                                                                              listadoMovimientos,
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe clonar ingreso con datos adicionales y editarlos', async ({
                                                                             movimientosNav,
                                                                             registroMovimiento,
                                                                             datosOpcionales,
                                                                             resultadoMovimiento,
