...
import {ALMACENES, ITEMS_TEST, PATRON_CODIGO, VARIANTES,} from '../../../src/helpers/Logistica/movimiento-data.helper';
import {KardexVerificacionPage} from '../../../src/pages/Logistica/KardexVerificacionPage';

test.describe('Eliminación de Movimientos @eliminacion', {tag: ['@logistica', '@movimientos']}, () => {

    // ═══════════════════════════════════════════════════════════════
    // Scenario 31: Eliminar movimiento correctamente
    // ═══════════════════════════════════════════════════════════════
    test('debe eliminar una salida y reflejar en stock, bitácora y kardex', async ({
                                                                                       movimientosNav,
                                                                                       registroMovimiento,
                                                                                       resultadoMovimiento,
                                                                                       listadoMovimientos,
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe eliminar salida con variante y reflejar en stock y kardex', async ({
                                                                                      movimientosNav,
                                                                                      registroMovimiento,
                                                                                      resultadoMovimiento,
                                                                                      listadoMovimientos,
        ...
        await test.step('And: verificar stock y kardex antes de eliminar', async () => {
            ...
            await kardexVerificacion.abrirVerDetalle(1); // o el índice que corresponda
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe bloquear eliminación cuando genera stock negativo', async ({
                                                                              movimientosNav,
                                                                              registroMovimiento,
                                                                              resultadoMovimiento,
                                                                              listadoMovimientos,
