...
test.describe('Edición de Movimientos @edicion', {tag: ['@logistica', '@movimientos']}, () => {

    // ═══════════════════════════════════════════════════════════════
    // Scenario 23: Editar movimiento correctamente (cantidad)
    // Para edición: se crea un ingreso y luego se edita
    // ═══════════════════════════════════════════════════════════════
    test('debe editar la cantidad de un ingreso y reflejar cambio en stock y kardex', async ({
                                                                                                 movimientosNav,
                                                                                                 registroMovimiento,
                                                                                                 resultadoMovimiento,
                                                                                                 listadoMovimientos,
        ...
        await test.step('Assert: verificar en kardex', async () => {
            ...
            await kardexVerificacion.abrirVerDetalle(1);
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe editar un ingreso con variante y reflejar cambio', async ({
                                                                             movimientosNav,
                                                                             registroMovimiento,
                                                                             resultadoMovimiento,
                                                                             listadoMovimientos,
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe editar ingreso con control estricto y permitir guardar', async ({
                                                                                   movimientosNav,
                                                                                   registroMovimiento,
                                                                                   resultadoMovimiento,
                                                                                   listadoMovimientos,
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe bloquear edición cuando afecta la integridad del movimiento', async ({
                                                                                        movimientosNav,
                                                                                        registroMovimiento,
                                                                                        resultadoMovimiento,
                                                                                        listadoMovimientos,
    ...
    // ═══════════════════════════════════════════════════════════════
    test('debe editar un movimiento y actualizar sus datos adicionales', async ({
                                                                                    movimientosNav,
                                                                                    registroMovimiento,
                                                                                    datosOpcionales,
                                                                                    resultadoMovimiento,
