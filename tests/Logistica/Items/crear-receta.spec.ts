...
test.describe('Creación de Recetas', () => {
  ...
  test('crear receta con productos estrictos', async ({
    ...
    const componentes: InsumoReceta[] = [
      ...
      { codigoBusqueda: '131313', textoSeleccion: 'item variante estricto gravado', variante: 'Variante 3 estricto' },
      { codigoBusqueda: '101010', textoSeleccion: 'item equivalente estricto', equivalencia: 'item equivalente estricto gravado' },
