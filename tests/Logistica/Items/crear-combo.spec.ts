...
test.describe('Creación de Combos', () => {
  ...
  test('crear combo con items estrictos gravados', async ({
    ...
    const componentes: ComponenteCombo[] = [
      ...
      { codigoBusqueda: '131313', textoSeleccion: 'item variante estricto gravado', variante: 'Variante 1 estricto' },
      { codigoBusqueda: '101010', textoSeleccion: 'item equivalente estricto gravado', equivalencia: 'Equivalente X2' },
    ];
