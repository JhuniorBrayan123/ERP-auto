# Skill Registry — automate-quotation-order-emissions
...
### capacity
- Path: C:\Users\USER\.agents\skills\microsoft-foundry\models\deploy-model\capacity\SKILL.md
- Rules:
...
### customize
- Path: C:\Users\USER\.agents\skills\microsoft-foundry\models\deploy-model\customize\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### deploy-model
- Path: C:\Users\USER\.agents\skills\microsoft-foundry\models\deploy-model\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
...
### microsoft-foundry
- Path: C:\Users\USER\.agents\skills\microsoft-foundry\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
...
### plugin-creator
- Path: C:\Users\USER\.codex\skills\.system\plugin-creator\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### preset
- Path: C:\Users\USER\.agents\skills\microsoft-foundry\models\deploy-model\preset\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
...
### skill-installer
- Path: C:\Users\USER\.codex\skills\.system\skill-installer\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### slides
- Path: C:\Users\USER\.codex\skills\codex-primary-runtime\slides\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### spreadsheets
- Path: C:\Users\USER\.codex\skills\codex-primary-runtime\spreadsheets\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
