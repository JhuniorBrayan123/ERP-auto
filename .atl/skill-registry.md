...
| `capacity` | — | user | `C:\Users\USER\.agents\skills\microsoft-foundry\models\deploy-model\capacity\SKILL.md` |
...
| `customize` | — | user | `C:\Users\USER\.agents\skills\microsoft-foundry\models\deploy-model\customize\SKILL.md` |
| `deploy-model` | — | user | `C:\Users\USER\.agents\skills\microsoft-foundry\models\deploy-model\SKILL.md` |
...
| `imagegen` | — | user | `C:\Users\USER\.codex\skills\.system\imagegen\SKILL.md` |
...
| `microsoft-foundry` | — | user | `C:\Users\USER\.agents\skills\microsoft-foundry\SKILL.md` |
...
| `spreadsheets` | — | user | `C:\Users\USER\.codex\skills\codex-primary-runtime\spreadsheets\SKILL.md` |
