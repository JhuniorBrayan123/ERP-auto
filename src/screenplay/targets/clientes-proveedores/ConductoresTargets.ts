...
export const ConductoresTargets = {
    ...
    opcionEditarConductor: (page: Page) =>
        page.locator('[id="pv_conductores_cmp-grid-options:opciones_conductor_cmp-dropdown:options-li:edicion-conductor"]'),

    opcionVerBitacora: (page: Page) =>
        page.locator('[id="pv_conductores_cmp-grid-options:opciones_conductor_cmp-dropdown:options-li:ver-bitacora"]'),

    opcionVerGuias: (page: Page) =>
        page.locator('[id="pv_conductores_cmp-grid-options:opciones_conductor_cmp-dropdown:options-li:ver-ventas"]'),

    opcionVerNotas: (page: Page) =>
        page.locator('[id="pv_conductores_cmp-grid-options:opciones_conductor_cmp-dropdown:options-li:notas-conductor"]'),

    opcionEliminarConductor: (page: Page) =>
        page.locator('[id="pv_conductores_cmp-grid-options:opciones_conductor_cmp-dropdown:options-li:eliminar-conductor"]'),

    opcionDesactivarConductor: (page: Page) =>
        page.locator('[id="pv_conductores_cmp-grid-options:opciones_conductor_cmp-dropdown:options-li:desactivar-conductor"]'),
    ...
    selectTipoLicencia: (page: Page) =>
        page.locator('id=pv_conductores_form-registro-relacionado-entidad:form_basico:v-select:tipo-licencia'),
    ...
    btnCrearConductorForm: (page: Page) =>
        page.locator('[idx="pv_cmp-header-relacionado-entidad_opciones_add_relacionado_conductor:button"]').first(),
