...
export interface ItemConfig {
    precioVenta: string;
    precioCompra: string;
    controlStock: 'estricto' | 'flexible' | 'sin_control';
    almacen?: string;
...
export const ITEM_TEMPLATES: ItemTemplate[] = [
    ...
    {
        key: 'ITEM_EQUIVALENTE_SIN_CONTROL',
        codigoBase: '303030',
    ...
    },
    {
        ...
        config: {
            ...
            variantes: {
                ...
                items: [
                    {nombre: 'Variante 1 flexible', stock: {cantidadMaxima: '1000', cantidadMinima: '1000'}},
                    {nombre: 'Variante 2 flexible', stock: {cantidadMaxima: '1000', cantidadMinima: '1000'}},
                    {nombre: 'Variante 3 flexible', stock: {cantidadMaxima: '1000', cantidadMinima: '1000'}},
                ],
            },
        },
    },
    {
        ...
        config: {
            ...
            variantes: {
                ...
                items: [
                    {nombre: 'Variante 1 estricto', stock: {cantidadMaxima: '5000', cantidadMinima: '5000'}},
                    {nombre: 'Variante 2 estricto', stock: {cantidadMaxima: '2', cantidadMinima: '2'}},
    ...
    },
    {
        ...
        config: {
            ...
            controlStock: 'sin_control',
            productosLista: [
                {codigoBusqueda: 'ESTRICTO_GRAVADO_2', textoSeleccion: 'Item control estricto gravado 2'},
                {codigoBusqueda: 'ESTRICTO_GRAVADO_5', textoSeleccion: 'Item control estricto gravado 5'},
                {codigoBusqueda: 'ESTRICTO_GRAVADO_8', textoSeleccion: 'Item control estricto gravado 8'},
                {codigoBusqueda: 'ESTRICTO_GRAVADO_10', textoSeleccion: 'Item control estricto gravado 10'},
                {codigoBusqueda: 'ITEM_SELECTOR_GRAVADO', textoSeleccion: 'item selector gravado'},
            ],
        },
    },
    {
